...
icon_deletar = PhotoImage(file="deletar.png").subsample(4,4)



fonte_cabecalho = font.Font(family = "Silkscreen", size = 24 , weight= "normal")
...
entrada_tarefa = tk.Entry(frame, font = ("Silkscreen", 14), relief = tk.FLAT, bg ="white", fg = "grey", width = 30 )
entrada_tarefa.insert(0,"Escreva sua tarefa aqui")
...
botao_adicionar = tk.Button(frame, text= "Adicionar Tarefa", command = adicionar_tarefa, bg = "#4C4F50", fg = "white", height = 1, width = 15, font = ("Silkscreen",11), relief = tk.FLAT )
